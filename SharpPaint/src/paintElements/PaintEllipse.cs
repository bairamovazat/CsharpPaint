...
namespace SharpPaint.src.paintElements
{
    class PaintEllipse : IPaintObject
    {
        ...
        public PaintEllipse(Graphics graphics)
        {
            this.Graphics = graphics;
        }

        public PaintEllipse(Graphics graphics, Color color, int size)
        {
            this.Graphics = graphics;
            this.Color = color;
            this.LineSize = size;
        ...
        public void Draw()
        {
            ...
            graphics.DrawEllipse(pen, new Rectangle(x, y, width, height));
        }
